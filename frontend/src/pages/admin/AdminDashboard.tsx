...
import BorrowedBooksTab from '../../components/admin/BorrowedBooksTab';
              ...
              <div className="card">
                ...
                {loading ? (
                  ...
                  <div className="text-center py-8">
                    <p className="text-neutral-600 dark:text-neutral-400">No reserved books found.</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                    {reservedBooks.slice(0, 3).map((book) => (
                      <div key={book.id} className="border-b border-neutral-200 dark:border-neutral-700 pb-3 last:border-b-0">
                        <h4 className="font-medium text-neutral-900 dark:text-neutral-100">{book.title}</h4>
                        <p className="text-sm text-neutral-600 dark:text-neutral-400">
                          Reserved by {book.reserverName} • Position: {book.position}
                        </p>
                      </div>
                    ))}
                  </div>
